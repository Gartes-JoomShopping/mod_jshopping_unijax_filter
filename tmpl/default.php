...
?>
<form action="<?php echo $modHelper->action ?>" id="jshop_unijax_filter" name="jshop_unijax_filter" method="post" data-params='{<?php echo implode(',', $dataParams) ?>}'>
...
<?php echo $modHelper->params->post_processing ?>
};
</script>
<?php } ?>